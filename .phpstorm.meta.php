...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.basset.driver' => 'string',
            'filesystems.disks.basset.root' => 'string',
            'filesystems.disks.basset.url' => 'string',
            'filesystems.disks.basset.visibility' => 'string',
            'filesystems.disks.basset.throw' => 'boolean',
            'filesystems.disks.basset.report' => 'boolean',
            'filesystems.links./home/reyfuu/inertia/public/storage' => 'string',
...
'auth.guards.web.provider','auth.guards.backpack.driver','auth.guards.backpack.provider','auth.providers.users.driver','auth.providers.users.model',
'auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.passwords.backpack.provider',
'auth.passwords.backpack.table','auth.passwords.backpack.expire','auth.passwords.backpack.throttle','auth.password_timeout','cache.default',
...
'filesystems.disks.s3.report','filesystems.disks.basset.driver','filesystems.disks.basset.root','filesystems.disks.basset.url','filesystems.disks.basset.visibility',
'filesystems.disks.basset.throw','filesystems.disks.basset.report','filesystems.links./home/reyfuu/inertia/public/storage','gravatar.default.size','gravatar.default.fallback',
'gravatar.default.secure','gravatar.default.maximumRating','gravatar.default.forceDefault','gravatar.default.forceExtension','inertia.ssr.enabled',
...
'debugbar.openhandler','debugbar.cache.delete','debugbar.queries.explain','debugbar.clockwork','debugbar.assets','login','register','logout','dashboard',
'user.index','user.store','user.update','user.destroy','bimbingan.index',
'bimbingan.komentar','bimbingan.store','bimbingan.update','bimbingan.destroy','laporan.index',
'laporan.store','laporan.update','laporan.destroy','laporan-mingguan.index','laporan-mingguan.store',
'laporan-mingguan.update','laporan-mingguan.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'app','vendor.backpack.crud.buttons.create_custom','vendor.backpack.crud.buttons.ubah','vendor.backpack.theme-tabler.auth.login','vendor.backpack.theme-tabler.auth.register',
'vendor.backpack.theme-tabler.buttons.create_custom','vendor.backpack.theme-tabler.buttons.komentar','vendor.backpack.theme-tabler.buttons.ubah','vendor.backpack.theme-tabler.dashboard','vendor.backpack.theme-tabler.inc.menu_items',
'vendor.backpack.theme-tabler.layouts.vertical','vendor.backpack.ui.auth.login','vendor.backpack.ui.auth.register','vendor.backpack.ui.buttons.create_custom','vendor.backpack.ui.buttons.ubah',
'vendor.backpack.ui.dashboard','vendor.backpack.ui.inc.menu_items','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'SESSION_DOMAIN','TELEGRAM_BOT_TOKEN','TELEGRAM_CHAT_ID','BROADCAST_CONNECTION','FILESYSTEM_DISK',
...
'VITE_APP_NAME','VITE_LARAVEL_URL','INERTIA_USE_SCRIPT_ELEMENT_FOR_INITIAL_PAGE','INERTIA_SSR_ENABLED',);
